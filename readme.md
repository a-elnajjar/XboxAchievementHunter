...
> **Status:** starting simple — two working tools (`GetPlayerProfile`, `ListPlayedTitles`). More tools
...
| `ListPlayedTitles` | List a player's played games (by XUID) → title IDs and achievement progress |
